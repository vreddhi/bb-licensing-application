var Navigation = {
	...
	sendStatus:function(){
		...
		if(Framework.mode == "scorm"){
			...
			var progress = cnt/Framework.PageVisitedStatus.length;
			progress = progress.toFixed(2);
			doLMSSetValue(Framework.completion,Framework.currentIndex, Framework.PageVisitedStatus.toString(),score, progress );
